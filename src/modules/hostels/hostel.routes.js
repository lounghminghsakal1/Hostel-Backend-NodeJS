...
import { updateHostelRequestBodySchema } from "./hostel.request-schema.js";
...
hostelRouter.patch("/:id", authenticateUserMiddleware, authorizeUserMiddleware(hostelAdminRole), validateRequestMiddleware({body: updateHostelRequestBodySchema}), HostelController.updateHostel);
